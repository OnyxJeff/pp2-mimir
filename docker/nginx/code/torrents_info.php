        ...
        <div class="info-box blue-bg">
            ...
            <?php
                if ($client == "qbittorent"){
                    echo round(intval($global_info['dl_info_speed'])/1024/1024, 2) . " MB/s";
                } elseif ($client == "transmission"){
                    echo round(intval($global_info['downloadSpeed'])/1024/1024, 2) . " MB/s";
                }
            ?>
            </span></h3>
            <?php
    ...
    <div class="col-lg-6 col-md-3 col-sm-12 col-xs-12">
        <div class="info-box green-bg">
            <h3>Seeding <span class="speeds">
                <?php
                    if ($client == "qbittorent"){
                        echo round(intval($global_info['up_info_speed'])/1024/1024, 2) . " MB/s"; 
                    } elseif ($client == "transmission"){
                        echo round(intval($global_info['uploadSpeed'])/1024/1024, 2) . " MB/s";
                    }
                ?>
            </span></h3>
            <?php
