    ...
    function checkConfig()
    {
        ...
        foreach($config as $line)
        {
            ...
            switch($param){
                ...
                case "storage_path_1": break;
                case "storage_name_1": break;
                case "show_storage_1": break;
                case "storage_path_2": break;
                case "storage_name_2": break;
				case "show_storage_2": break;
